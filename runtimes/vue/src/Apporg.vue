...
function updateThemeData(theme: ThemeData) {
  ...
  alertVariants.value = theme.alerts?.variants || [{ name: 'Info' }, { name: 'Success' }, { name: 'Warning' }]
  ...
  <div class="sg-styleguide">
    ...
    <main class="sg-main">
          ...
          <div v-for="variant in progressVariants" :key="variant.name" class="sg-progress-item">
            ...
            <div class="cux-progress" :class="`--${toKebabCase(variant.name)}`">
              ...
              <div
                ...
                :class="{
                  '--striped': variant.type === 'striped' || variant.type === 'animated',
                  '--animated': variant.type === 'striped' || variant.type === 'animated'
                }"
                style="width: 50%"
              ></div>
      ...
      <section class="sg-section">
        ...
        <div class="sg-showcase-area">
          <div v-for="variant in spinnerVariants" :key="variant.name" class="sg-spinner-item">
            <div
              class="cux-spinner"
              :class="`--${toKebabCase(variant.name)}`"
              v-html="getSpinnerHTML(variant.type)"
            ></div>
...
.sg-section:nth-child(1) {
  animation-delay: 0.05s;
}
.sg-section:nth-child(2) {
  animation-delay: 0.1s;
}
.sg-section:nth-child(3) {
  animation-delay: 0.15s;
}
.sg-section:nth-child(4) {
  animation-delay: 0.2s;
}
.sg-section:nth-child(5) {
  animation-delay: 0.25s;
}
.sg-section:nth-child(6) {
  animation-delay: 0.3s;
}
.sg-section:nth-child(7) {
  animation-delay: 0.35s;
}
.sg-section:nth-child(8) {
  animation-delay: 0.4s;
}
.sg-section:nth-child(9) {
